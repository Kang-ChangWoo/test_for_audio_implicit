...
def main():
    ...
    ax.set_title("Final multi-seed ranking (3 seeds) — implicit attn (self/cross) BEATS A0 decoder\n"
                 "robustly (~2%, gap≫error bars); RayMLP worst; phase/residual/SH ≈ decoder. Ceiling ~0.775")
